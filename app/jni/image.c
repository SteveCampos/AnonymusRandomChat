...
JNIEXPORT void Java_apps_steve_fire_randomchat_AndroidUtilities_blurBitmap(JNIEnv *env, jclass class, jobject bitmap, int radius) {
    if (!bitmap) {
        return;
    }
...
JNIEXPORT void Java_apps_steve_fire_randomchat_AndroidUtilities_loadBitmap(JNIEnv *env, jclass class, jstring path, jobject bitmap, int scale, int width, int height, int stride) {
