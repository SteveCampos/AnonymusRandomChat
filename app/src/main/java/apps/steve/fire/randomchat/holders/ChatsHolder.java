...
public class ChatsHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(final RandomChat item, String androidID, Context mContext, final OnChatItemClickListener listener){
        ...
        switch (item.getLastMessage().getMessageType()){
            case Constants.MESSAGE_IMAGE:
                message = mContext.getString(R.string.message_image);
                break;
        }
        ...
        if (item.getLastMessage().getAndroidID().equals(ChatMessage.AUTOMATIC)){
            switch (message){
                ...
                case ChatMessage.UNBLOCKED:
                    ...
                    break;
                case ChatMessage.PARED_BY_POST:
                    message = mContext.getString(R.string.chat_state_pared_by_post);
                    break;
                default:
                    break;
            }
