...
public class Constants {
    ...
    public static final String CHAT_STATE_UNBLOCKED = "UNBLOCKED";
    ...
    public static final String PREF_NOTI_KEYS = "noti_keys";
    public static final String PREF_NOTI_KEY_EXTRAS = "noti_keys_extras";
