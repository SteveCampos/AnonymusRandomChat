...
public class CircledPicker extends View {
    ...
    private OnSliderMoveListener myOwnListener;
    ...
    public void setOnMoveListener(OnSliderMoveListener listenerSliderMove) {
        this.myOwnListener = listenerSliderMove;
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mSubLineColor = typedArray.getColor(R.styleable.CircledPicker_subLineColor, resources.getColor(R.color
                .defaultSubLineColor));
        mTextColor = typedArray.getColor(R.styleable.CircledPicker_textColorCirclePicker, resources.getColor(R.color.defaultLineColor));
